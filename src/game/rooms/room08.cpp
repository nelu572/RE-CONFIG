...
extern const RoomDef g_room08 = {
    ...
    0,
    g_room08_speakers,
    (int)(sizeof(g_room08_speakers) / sizeof(g_room08_speakers[0])),
    { T(8), T(15), T(2), T(2) },
    T(4),
    T(50),
    { T(0), T(0), T(48), T(54) },
    ...
    g_room08_gravity_boxes,
    (int)(sizeof(g_room08_gravity_boxes) / sizeof(g_room08_gravity_boxes[0])),
    g_room08_pressure_switches,
    (int)(sizeof(g_room08_pressure_switches) / sizeof(g_room08_pressure_switches[0])),
    g_room08_pressure_platforms,
    (int)(sizeof(g_room08_pressure_platforms) / sizeof(g_room08_pressure_platforms[0])),
    0,
};