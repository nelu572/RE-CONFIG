...
static const RectF g_room10_platforms[] = {
    ...
    { T(132), T(12), T(1), T(26) }, { T(136), T(12), T(1), T(35) }, { T(5), T(22), T(1), T(3) },
    ...
    { T(126), T(34), T(6), T(4) }, { T(40), T(35), T(13), T(3) }, { T(104), T(43), T(1), T(2) }, { T(104), T(47), T(1), T(7) },
    { T(110), T(43), T(1), T(4) }, { T(27), T(44), T(35), T(4) }, { T(90), T(44), T(1), T(3) },
    { T(111), T(45), T(11), T(2) }, { T(123), T(45), T(3), T(2) }, { T(128), T(45), T(8), T(2) },
    { T(122), T(46), T(1), T(1) }, { T(126), T(46), T(2), T(1) }, { T(14), T(47), T(13), T(4) },
    { T(109), T(47), T(1), T(4) }, { T(27), T(48), T(5), T(3) }, { T(0), T(50), T(14), T(4) },
    { T(14), T(51), T(5), T(3) }, { T(110), T(50), T(26), T(1) }, { T(136), T(50), T(1), T(4) },
    { T(105), T(53), T(29), T(1) },
};
static const RectF g_room10_type_a_walls[] = { { T(69), T(34), T(3), T(1) }, { T(48), T(38), T(2), T(6) } };
static const SpeakerDevice g_room10_speakers[] = { DefaultSpeakerAt(T(58), T(31)) };
...
static const GravityBoxDef g_room10_gravity_boxes[] = { { DefaultGravityBoxAt(T(119.25f), T(32.25f)) } };
static const PressureSwitchDevice g_room10_pressure_switches[] = {
    { { T(110), T(33), T(2), T(1) } }, { { T(126), T(45), T(2), T(1) } },
    { { T(23), T(21), T(2), T(1) } }, { { T(78), T(21), T(2), T(1) } },
    { { T(109), T(43), T(1), T(2) } }, { { T(129), T(44), T(2), T(1) } },
};
static const PressurePlatformDevice g_room10_pressure_platforms[] = {
    ...
    { { T(132), T(38), T(1), T(7) }, 0.0f, T(7), 1u << 1 },
    { { T(91), T(45), T(19), T(2) }, 0.0f, 0.0f, 1u << 4, 1 },
    { { T(122), T(44), T(1), T(2) }, 0.0f, T(2), 1u << 5 },
...
static const WalkerEnemyDef g_room10_walker_enemies[] = {
    ...
    { { T(95.25f), T(44.10f), T(1.5f), T(0.9f) }, 140.0f, -1, WALKER_ENEMY_M1 },
    { { T(114.25f), T(44.10f), T(1.5f), T(0.9f) }, 100.0f, 1, WALKER_ENEMY_M2 },
};
...
extern const RoomDef g_room10 = {
    ...
    { T(135), T(44), T(1), T(1) }, T(90), T(43), { T(0), T(0), T(137), T(54) }, T(4), GRAVITY_DOWN,
    kDefaultDeleteState, g_room10_pistons, (int)(sizeof(g_room10_pistons) / sizeof(g_room10_pistons[0])),
    g_room10_gravity_boxes, (int)(sizeof(g_room10_gravity_boxes) / sizeof(g_room10_gravity_boxes[0])),
