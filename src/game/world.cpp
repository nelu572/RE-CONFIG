...
static const RoomDef g_rooms[] = {
    ...
    { g_room03_platforms, (int)(sizeof(g_room03_platforms) / sizeof(g_room03_platforms[0])), 0, 0, g_room03_speakers, (int)(sizeof(g_room03_speakers) / sizeof(g_room03_speakers[0])), { T(58), T(21), T(2), T(2) }, T(6), T(23) - 40.0f, { T(0), T(0), T(64), T(27) }, T(4), GRAVITY_DOWN, g_default_delete_state },
};
